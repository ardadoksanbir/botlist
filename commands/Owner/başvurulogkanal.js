...
module.exports.run = async (client, message, args) => {
  ...
  db.set(`ruxlogkanal_${message.guild.id}`, kanal.id);
  message.channel.send(`Başvuru log kanalı başarıyla ${kanal} olarak ayarlandı!`).then(x => x.delete({timeout: 6000}))
};

module.exports.help = {
    name: "başvurulogkanal",
    description: "",
    aliases: []
};